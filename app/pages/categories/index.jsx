  ...
  return (
    <div className="relative p-5 overflow-x-auto">
      <div className="flex items-center justify-between mb-11">
        <h1 className="text-5xl font-semibold text-white">List Kategori</h1>
        <Link to="/category/create" className="btn text-black bg-[#e0b1cb] hover:bg-[#be95c4]">Create New</Link>
      </div>
        ...
        <table className="table w-full text-center">
          <thead>
            <tr>
              ...
              <th className="bg-[#231942] text-white">Jenis</th>
          ...
          <tbody>
            ...
            </tr> : category.map((ctgr, index) => (
              <tr key={index}>
                <th className="bg-[#FFFBEB]">{index + 1}</th>
                <td className="bg-[#FFFBEB]">{ctgr.name}</td>
                <td className="bg-[#FFFBEB]">{ctgr.jenis}</td>
                <td className="bg-[#FFFBEB]">
                  <Link
                    to={`/category/edit/${ctgr.id}`}
