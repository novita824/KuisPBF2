  ...
  return (
    <div className="relative p-5 overflow-x-auto">
      <div className="flex items-center justify-between mb-11">
        <h1 className="text-5xl font-semibold text-white">List Unit </h1>
        <Link to="/Barang/create" className="btn text-black bg-[#e0b1cb] hover:bg-[#be95c4]">Create New</Link>
      </div>
      <div className="overflow-x-auto">
        <table className="table w-full text-center">
          <thead>
            <tr>
              <th className="bg-[#231942] text-white">No</th>
              <th className="bg-[#231942] text-white">Name</th>
              <th className="bg-[#231942] text-white">Color</th>
              <th className="bg-[#231942] text-white">Price</th>
              <th className="bg-[#231942] text-white">Action</th>
            </tr>
          </thead>
          <tbody>
            {isLoading ? <tr>
            ...
            </tr> : Barang.map((vhc, index) => (
              <tr key={index}>
                <th className="bg-[#FFFBEB]">{index + 1}</th>
                <td className="bg-[#FFFBEB]">{vhc.name}</td>
                <td className="bg-[#FFFBEB]">{vhc.color}</td>
                <td className="bg-[#FFFBEB]">{vhc.price.toLocaleString()}</td>
                <td className="bg-[#FFFBEB]">
                  <Link
                    to={`/Barang/edit/${vhc.id}`}
